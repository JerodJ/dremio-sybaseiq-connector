...
@SourceType(value = "SybaseIQARP", label = "SybaseIQ",uiConfig = "sybaseiq-layout.json")
public class SybaseIQConf extends AbstractArpConf<SybaseIQConf> {
  private static final String ARP_FILENAME = "arp/implementation/sybaseiq-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.sybaseiq.SybaseIQDriver";
